...
export default function ProductPage() {
  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-[#EDEBE8] flex items-center justify-center">
        <p className="text-[#6B6862] text-[13px] tracking-[0.3em]" style={{ fontFamily: "var(--font-inter)" }}>
          PIECE NOT FOUND
        </p>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-[#EDEBE8] text-[#2A2A28] overflow-hidden">
      {/* Header */}
      <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 sm:px-12 py-6"
        style={{ background: "linear-gradient(to bottom, rgba(237,235,232,0.95) 0%, transparent 100%)" }}
      >
        <Link href="/"
          className="text-[18px] sm:text-[20px] font-[300] tracking-[0.1em] text-[#2A2A28]/40 hover:text-[#C5A572] transition-colors duration-500"
          style={{ fontFamily: "var(--font-playfair)" }}
        >
          NJ
        </Link>
        <Link href="/"
          className="text-[10px] font-[300] tracking-[0.5em] text-[#6B6862] uppercase hover:text-[#C5A572] transition-colors duration-300"
      ...
      <div className="lg:hidden min-h-screen flex flex-col">
        ...
        <div className="relative flex items-center justify-center pt-24 pb-6" style={{ minHeight: "45vh" }}>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] h-[60vh] pointer-events-none"
            style={{ background: "radial-gradient(ellipse at center, rgba(197,165,114,0.03) 0%, transparent 55%)" }}
          />
          ...
          <motion.img
            ...
            src={product.image}
            alt={product.name}
            className="w-[70vw] max-w-[380px] product-shadow relative z-10"
          />
        </div>
        ...
        >
          <p className="text-[9px] font-[300] tracking-[0.5em] text-[#6B6862] uppercase mb-3"
            style={{ fontFamily: "var(--font-inter)" }}>
            {product.category}
          </p>
          ...
          <p className="text-[13px] font-[300] leading-[1.9] text-[#6B6862] mb-6"
            style={{ fontFamily: "var(--font-inter)" }}>
            {product.description}
          </p>
          <p className="text-[9px] font-[300] tracking-[0.3em] text-[#6B6862]/60 uppercase"
            style={{ fontFamily: "var(--font-inter)" }}>
            {product.materials}
          </p>
        </motion.div>
        ...
        {/* Sticky CTA */}
        <div className="fixed bottom-0 left-0 right-0 z-50 px-8 pt-4 border-t border-[#2A2A28]/5"
          style={{ background: "linear-gradient(to top, rgba(237,235,232,0.98) 70%, transparent 100%)", paddingBottom: "max(env(safe-area-inset-bottom, 12px), 16px)" }}
        >
          <motion.button
            whileTap={{ scale: 0.98 }}
            className="w-full py-3.5 border border-[#C5A572]/40 text-[10px] font-[300] tracking-[0.5em] text-[#C5A572] uppercase hover:bg-[#C5A572] hover:text-[#EDEBE8] transition-colors duration-500"
            style={{ fontFamily: "var(--font-inter)" }}
          >
      ...
      <div className="hidden lg:flex min-h-screen">
        ...
        <div className="relative flex-1 flex items-center justify-center">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] pointer-events-none"
            style={{ background: "radial-gradient(ellipse at center, rgba(197,165,114,0.04) 0%, rgba(197,165,114,0.04) 35%, transparent 55%)" }}
          />
          ...
          <motion.img
            ...
            src={product.image}
            alt={product.name}
            className="w-[32vw] max-w-[480px] product-shadow relative z-10"
          />
        </div>
        ...
        <motion.div
          ...
          className="flex-shrink-0 w-[380px] xl:w-[420px] flex flex-col justify-center px-14 xl:px-16 py-20 border-l border-[#2A2A28]/5"
        >
          <p className="text-[10px] font-[300] tracking-[0.5em] text-[#6B6862] uppercase mb-5"
            style={{ fontFamily: "var(--font-inter)" }}>
            {product.category}
          </p>
          ...
          <p className="text-[13px] font-[300] leading-[1.9] text-[#6B6862] mb-8"
            style={{ fontFamily: "var(--font-inter)" }}>
            {product.description}
          </p>
          <p className="text-[8px] xl:text-[9px] font-[300] tracking-[0.25em] xl:tracking-[0.3em] text-[#6B6862]/50 uppercase mb-10 whitespace-nowrap"
            style={{ fontFamily: "var(--font-inter)" }}>
            {product.materials}
          </p>
          <div className="w-full h-[1px] bg-[#2A2A28]/5 mb-8" />
          <motion.button
            whileHover={{ backgroundColor: "#C5A572", color: "#EDEBE8" }}
            whileTap={{ scale: 0.98 }}
          ...
          <p className="text-center mt-4 text-[9px] font-[300] tracking-[0.3em] text-[#6B6862]/40 uppercase"
            style={{ fontFamily: "var(--font-inter)" }}>
